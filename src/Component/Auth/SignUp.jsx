                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6">
                            ...
                            <div className="md:flex justify-between">
                                <div>
                                    <label htmlFor="fname" className="block mb-4 text-sm font-medium text-gray-900">Firstname</label>
                                    <input type="text" name="fname" id="fname" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Firstname" required />
                                </div>
                                <div>
                                    <label htmlFor="lname" className="block mb-4 text-sm font-medium text-gray-900">Lastname</label>
                            ...
                            <div>
                                <label htmlFor="password" className="block mb-4 text-sm font-medium text-gray-900">Password</label>
                            ...
                            <p className="text-sm font-light text-gray-600">
                                Don’t have an account yet? <Link to={'/'} className="font-medium text-primary-700 hover:underline">Log In</Link>
                            </p>
                        </form>
                    </div>
                </div>
